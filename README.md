...
| Stereo | User-verified fused **1584×1440**. SteamVR recommended (~3296×3216) offscreen eyes (`steamvr_rt`) blacked desktop and HMD — persist-skipped. SteamVR overlay SS does not change BM G-buffers; they cannot be larger than the game window on this path. |
